...
const Join = () => {
  ...
  //유효성 검사(Validation) 결과 에러메세지를 저장하는 state 변수
    ...
    switch(name){
      ...
      case 'memPw' : 
        ...
        if(value.length < 1){
          ...
          errorMsg = '영어/숫자 조합, 최대 50글자까지 가느합니다'
